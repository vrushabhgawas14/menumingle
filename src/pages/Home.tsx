  ...
  return (
    <>
      <main>
        ...
        {/* Home Page Section */}
        <section className="px-20 py-5 flex sm:flex-col w-full lg:h-[80vh] justify-between items-center sm:space-y-4">
          {/* Left Side */}
          <section className="p-4 px-6 w-[50vw] sm:w-[90vw] flex flex-col justify-center items-start sm:items-center sm:text-center space-y-4">
            ...
            <div className="flex justify-start space-x-4 sm:justify-center font-semibold w-full">
              <a
                href="/product"
                className="bg-amber-400 px-3 py-1 text-lg sm:text-base rounded-xl border-2 border-black hover:bg-opacity-20 cursor-pointer"
              >
